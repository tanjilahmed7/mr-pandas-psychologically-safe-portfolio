...
This repo contains code of Mr. Panda's Portfolio for a Codrops!! It's an unfinished concept portfolio website creatied with [Blender](https://www.blender.org/), [Three.js](https://threejs.org/), and [Krita](https://krita.org/en/). Let's fight back against toxicity in the creative industry.
